...
public class Sql {
    ...
    public static final String SQL_READ_STUDENT_INCL_SCHOOL_AND_GRADE = "SELECT Name, SchoolName, GradeDescription FROM Student JOIN StudentSchool USING(StudentId) JOIN School USING(SchoolId) JOIN StudentGrade USING(StudentId) JOIN Grade USING(GradeId)";
