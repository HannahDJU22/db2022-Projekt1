...
CREATE TABLE HOBBIES SELECT Id AS StudentId, SUBSTRING_INDEX((SUBSTRING_INDEX(Hobbies,', ',1)),', ',-1) AS Hobby FROM UNF
...
ALTER TABLE HOBBIES MODIFY COLUMN StudentId INT;
